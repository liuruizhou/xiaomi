...
<!-- start banner_x -->
		...
		<div class="gwcxqbj" hidden>
			<div class="gwcxd center" hidden>
		...
		<div style="background-color: #F5F5F5;text-align: center;">
			<img src="images/gouwuchenulldiv.png" usemap="#Map"/>
            <map name="Map">
              <area shape="rect" coords="540,253,712,303" title="登录后查看购物车" href="login.jsp">
              <area shape="rect" coords="726,253,897,303" title="前往首页" href="index.jsp">
            </map>
		</div>
		<!--新增推荐-->
