...
public class Orders {
	...
	public Orders(int goodsId, String orderNumber, String price, Date tradingHour, int stateId, int userId) {
		super();
	...
	public Orders(int id, int goodsId, String orderNumber, String price, Date tradingHour, int stateId, int userId) {
		super();
		this.id = id;
		this.goodsId = goodsId;
		this.orderNumber = orderNumber;
